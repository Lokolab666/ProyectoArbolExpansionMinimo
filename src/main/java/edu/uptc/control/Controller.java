...
public class Controller implements ActionListener{
    ...
    private Management management;
        ...
        public Controller(Actions actions) {
            ...
            actions.showGraph(Actions.GRAPH, management.getGraph());
            actions.showGraph(Actions.GRAPHMST, management.getGraphMST());
            actions.show(Actions.ORIGIN, management.getVertex());
            actions.show(Actions.DESTINY, management.getVertex());
            actions.showData(Actions.GRAPH, management.getGraphData());
            actions.showData(Actions.GRAPHMST, management.getMSTData());
        }
